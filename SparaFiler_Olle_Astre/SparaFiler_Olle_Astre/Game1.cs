...
namespace SparaFiler_Olle_Astre
{
    /// <summary>
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        // Score file name
        readonly string scoreFile = "Scores.dat";
        ...
        public static string[] Players = new string[] {"Player1", "Player2", "Player3"};
        ...
        protected override void Initialize()
        {
            ...
            {
                SaveData data = new SaveData(10);
                data.PlayerName[0] = "Blank";
                data.PlayerName[1] = "Blank";
                data.PlayerName[2] = "Blank";
                data.PlayerName[3] = "Blank";
                data.PlayerName[4] = "Blank";
                data.PlayerName[5] = "Blank";
                data.PlayerName[6] = "Blank";
                data.PlayerName[7] = "Blank";
                data.PlayerName[8] = "Blank";
                data.PlayerName[9] = "Blank";
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            switch (gameState)
            {
                case GameState.TitleScreen:
                    ...
                    spriteBatch.DrawString(font, "Use the left and right arrow keys to change player.".ToString(), new Vector2(120, 420), Color.White);
